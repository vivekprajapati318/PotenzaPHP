...
<body>
    ...
    <form method="post" class="ragister">
        ...
        <div class="form-group">
            <input type="button" value="varify Email" id="varify">
        </div>
        ...
        <div class="form-group">
            ...
            <div class="number" style="display:flex;">
                ...
                <select name="countryCode" id="CountryID">
                ...
                <input type="text" class="form-control" name="PhoneNumber" id="PhoneNumber" required placeholder="PhoneNumber">
            </div>
            <div class="form-group">
                <label for="bithdate">BirthDate</label>
                <input type="date" class="form-control" name="birthdate" id="birthdate" required placeholder="BirthDate">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="submit" class="button btn-primary submit-ragister" id="ragister" name="ragister" value="Register">
        </div>
    </form>
    <script>
        $(".alert").hide();
        $(document).ready(function() {
            ...
            $("#ragister").on("click", function(e) {
                ...
                if (nameErr || emailErr || phoneErr || passErr || DOBErr || click == 0) {
